...
namespace Petshop.Controllers
{
    public class ServicoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,animalId,ClienteId,TipoServicoId,valorTotal,horario,Data")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,animalId,ClienteId,TipoServicoId,valorTotal,horario,Data")] Servico servico)
        {
            if (id != servico.id)
            {
                return NotFound();
